...
- 归类：AI Agent / 编排框架
- Stars：33063
- Topics：slide, presentation, slides, office, powerpoint, pptx, ppt, powerpoint-generation, ai-agent, aippt
- 功能特点：
  - AI generates a real, editable PowerPoint from any document — native shapes &amp;amp; animations, speaker notes voiced as audio narration, and the option to follow your own .pptx template, not slide ima...
- 核心优势：
  - 目标清晰：从项目描述可直接定位其核心能力与落地方向
- 使用场景：
  - 构建/编排多步骤 AI Agent 工作流（工具调用、计划/执行、状态管理）
...
- 归类：AI Agent / 编排框架
- Stars：21383
- Topics：javascript, flux, open-source, text-to-image, lipsync, uncensored, muapi, image-to-video, text-to-video, creative-tools, generative-ai, ai-image-generation
- 功能特点：
  - Unrestricted Open-source alternative to AI video platforms — Free AI image &amp;amp; video generation studio with 200+ models (Flux, Midjourney, Kling, Sora, Veo). No content filters. Self-hosted, MIT ...
