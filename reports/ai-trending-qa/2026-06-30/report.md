# GitHub 今日 AI Trending 测开分析（2026-06-30）
...
- Stars：12765
- 主要语言：TypeScript
- Topics：authentication, authorization, email, identity, jwt, login, logto, mfa, oauth2, openid-connect, password, passwordless
- 项目特色（基于 description/README 片段的轻量提炼）：
