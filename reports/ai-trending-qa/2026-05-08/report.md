# GitHub 今日 AI Trending 测开分析（2026-05-08）
...
- 项目特色（基于 description/README 片段的轻量提炼）：
  ...
  - 🔥 **Agentic Vectorless RAG**（https://github.com/VectifyAI/PageIndex/blob/main/examples/agentic_vectorless_rag_demo.py） — A simple *agentic, vectorless RAG* example with self-hosted PageIndex, using OpenAI Agents SDK.
