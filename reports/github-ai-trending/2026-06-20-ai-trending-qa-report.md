...
- 归类：AI Agent / 编排框架
- Stars：8206
- Topics：tree-sitter, sqlite, mcp, opencode, code-analysis, ast, knowledge-graph, developer-tools, cursor, graph-visualization, cypher, codex
- 功能特点：
...
- 归类：应用层 / UI
- Stars：27611
- Topics：awesome, awesome-list, interview-questions, vision-and-language, notebook-jupyter, large-language-models, llms, generative-ai
- 功能特点：
